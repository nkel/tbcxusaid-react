                ...
                <button className="btn-add">
                    ...
                    <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none"
                        ...
                        <path
                            ...
                            stroke="#fff" stroke-width="1.5"/>
                        <path d="M8 13V17" stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round"/>
                        <path d="M16 13V17" stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round"/>
                        <path d="M12 13V17" stroke="#fff" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round"/>
                        <path
