        ...
        <button className="logOut-btn" onClick={() => handleLogOut()}>
          <span className="logOut-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
            <g transform="translate(-0.208)">
              ...
              <path d="M11.162,11.577v1.181A2.365,2.365,0,0,1,8.8,15.122H2.863A2.365,2.365,0,0,1,.5,12.759V2.363A2.365,2.365,0,0,1,2.863,0H8.8a2.365,2.365,0,0,1,2.363,2.363V3.544a.591.591,0,0,1-1.181,0V2.363A1.183,1.183,0,0,0,8.8,1.181H2.863A1.183,1.183,0,0,0,1.681,2.363v10.4A1.183,1.183,0,0,0,2.863,13.94H8.8a1.183,1.183,0,0,0,1.181-1.181V11.577a.591.591,0,0,1,1.181,0ZM15.19,6.546,13.867,5.223a.591.591,0,0,0-.835.835L13.972,7H6.88a.591.591,0,1,0,0,1.181h7.093l-.941.941a.591.591,0,1,0,.835.835L15.19,8.635A1.478,1.478,0,0,0,15.19,6.546Zm0,0" transform="translate(2.513 2.439)" fill="#fff" stroke="#fff" stroke-width="0.5"/>
            </g>
          </svg></span>
            <span>Log Out</span>
        </button>
